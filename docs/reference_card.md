# Serial Protocol Quick Reference: Cybersecurity Club
...
|------|------|------|
| **Logic Analyzer** | Captures and decodes UART/I2C/SPI/etc. | $170–500 |
...
| **Logic 2** | Logic Analyzer's protocol analyzer software | Free (software) |
