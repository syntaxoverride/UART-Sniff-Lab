/*
 * gateway_test.ino — "The Bank Board" (White Case)
 *
...
#define THRESH_LOW       1    // transitions per window to trigger LOW
#define THRESH_MEDIUM    6    // transitions per window to trigger MEDIUM
